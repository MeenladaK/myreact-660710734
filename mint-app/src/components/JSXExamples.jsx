...
function JSXExamples() {
    ...
    const user = {
        ...
        lastName: 'แก้วพินิจ',
        age: 20,
        hobbies: ['เล่นเกม', 'ฟังเพลง', 'เลี้ยงแมว']
    };
        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'เครื่องดูดไรฝุ่น', price: 2200, inStock: true },
                        { id: 2, name: 'เครื่องฟอกอากาศ', price: 7890, inStock: true },
                        { id: 3, name: 'เครื่องดูดฝุ่น', price: 2490, inStock: false }
                    ].map(product => (
